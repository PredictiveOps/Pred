	...
	return (
		<div className="space-y-6">
				...
				<div className="flex items-start gap-4">
					{onBack && (
						<button
							type="button"
							onClick={onBack}
							className="p-2 hover:bg-gray-100 rounded transition-colors mt-1"
						>
					...
					<div>
						...
						<p className="text-gray-500 text-sm">{assetInfo.location}</p>
					</div>
				</div>
					...
					<Card className="bg-white border-gray-200 p-6">
						...
						<div className="grid grid-cols-2 gap-6 mb-6">
							...
							<div>
								...
								<div className="text-xs text-gray-500">Estimated days</div>
							</div>
						</div>
						...
						<div className="h-40 flex items-end justify-around gap-2">
							<div className="flex flex-col items-center gap-2">
								<div
									...
									style={{ height: "140px" }}
								></div>
								<span className="text-xs text-gray-500">0x Harmonics</span>
							</div>
							<div className="flex flex-col items-center gap-2">
								<div
									...
									style={{ height: "90px" }}
								></div>
								<span className="text-xs text-gray-500">2x Harmonics</span>
							</div>
							<div className="flex flex-col items-center gap-2">
								<div
									...
									style={{ height: "40px" }}
								></div>
								<span className="text-xs text-gray-500">3x Harmonics</span>
							</div>
						</div>
				...
				<div className="space-y-6">
						...
						<div className="mb-6">
							...
							<div className="h-20 bg-gray-50 rounded flex items-center justify-center">
								<svg
									...
									role="img"
									aria-label="Temperature telemetry chart"
								>
									<polyline
						...
						<div>
							...
							<div className="h-20 bg-gray-50 rounded flex items-center justify-center">
								<svg
									...
									preserveAspectRatio="none"
									role="img"
									aria-label="Vibration telemetry chart"
								>
									<polyline
					...
					<Card className="bg-white border-gray-200 p-6">
						...
						<div className="mt-2 pt-2 border-t border-gray-200">
							<div className="text-xs text-gray-500 font-semibold uppercase mb-4">
								Sensor Node Status
							</div>
			...
			<div className="flex justify-end">
				<Button className="bg-blue-600 hover:bg-blue-700 text-white px-8 font-semibold uppercase text-sm">
